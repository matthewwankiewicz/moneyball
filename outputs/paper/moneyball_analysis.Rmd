...
The logistic regression model is run using the `glm()` function in R (@citeR). The decision to run this model over other models like linear regression was made by the fact that we are predicting a binary variable of a team's success in the season. Since there are only two possible options our data will likely follow an S shape and a straight line equation will not be helpful to model this relationship. As a straight line regression will likely miss many data points.
